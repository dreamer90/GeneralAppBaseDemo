 ...
 *  代理
 */
@protocol LVJCarouselViewDelegate <NSObject>
 ...
 *  其他属性都有默认值，可不设置
 */
@interface LVJCarouselView : UIView
 ...
 *  代理，用来处理图片的点击
 */
@property (nonatomic, weak) id<LVJCarouselViewDelegate> delegate;
